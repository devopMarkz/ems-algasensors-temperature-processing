...
import com.algaworks.algasensors.temperature.processing.infraestructure.rabbitmq.RabbitMQConfig;
...
public class TemperatureProcessingController {
    ...
    public void data(@PathVariable TSID sensorId, @RequestBody String input) {
        ...
        rabbitTemplate.convertAndSend(RabbitMQConfig.FANOUT_EXCHANGE_NAME, "", payload);
    }
